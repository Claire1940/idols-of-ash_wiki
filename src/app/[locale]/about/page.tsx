...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  return {
    title: 'About Idols of Ash Wiki - Your Ultimate itch.io / Steam Game Resource',
    description: 'Learn about Idols of Ash Wiki, a community-driven resource hub providing comprehensive guides, crafting tips, creature info, and strategies for the Idols of Ash itch.io / Steam game.',
    keywords: [
      'about Idols of Ash Wiki',
      'Idols of Ash community',
      'itch.io / Steam game wiki',
      'game resource hub',
      'Idols of Ash team',
    ],
    robots: {
    ...
    openGraph: {
      ...
      siteName: 'Idols of Ash Wiki',
      title: 'About Idols of Ash Wiki',
      description: 'Learn about our mission to provide the best Idols of Ash game resources and guides.',
      images: [
        {
          url: `${siteUrl}/og-image.jpg`,
          width: 1200,
          height: 630,
          alt: 'Idols of Ash Wiki',
        },
      ],
    },
    twitter: {
      ...
      title: 'About Idols of Ash Wiki',
      description: 'Learn about our mission to provide the best Idols of Ash game resources.',
      ...
      <section className="relative py-20 px-4 border-b border-border">
        <div className="container mx-auto max-w-4xl text-center">
          ...
          <p className="text-slate-300 text-lg mb-2">
            Your community-driven resource center for Idols of Ash
          </p>
        </div>
      </section>
      ...
      <section className="py-12 px-4">
        <div className="container mx-auto max-w-4xl">
          <div className="prose prose-invert prose-slate max-w-none">
            <h2>Welcome to Idols of Ash Wiki</h2>
            <p>
              Idols of Ash Wiki is an <strong>unofficial, fan-made resource website</strong> dedicated to helping players
              master the itch.io / Steam game "Idols of Ash". We are a community-driven platform that provides comprehensive guides,
            ...
            <p>
              ...
              Idols of Ash Wiki is here to support you every step of the way.
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="py-12 px-4 bg-slate-900/30">
        <div className="container mx-auto max-w-4xl">
          <div className="prose prose-invert prose-slate max-w-none">
            <h2>Our Mission</h2>
            <p>
              Our mission is simple: <strong>to empower Idols of Ash players with accurate, up-to-date information
            ...
            <h2>Our Vision</h2>
            <p>
              We envision Idols of Ash Wiki as the <strong>go-to destination</strong> for every Idols of Ash player seeking
      ...
      <section className="py-12 px-4 bg-slate-900/30">
        <div className="container mx-auto max-w-4xl">
          <div className="prose prose-invert prose-slate max-w-none">
            ...
            <p>
              Idols of Ash Wiki is built <strong>by the community, for the community</strong>. We welcome contributions,
      ...
      <section className="py-12 px-4">
        <div className="container mx-auto max-w-4xl">
          <div className="prose prose-invert prose-slate max-w-none">
            ...
            <p>
              Idols of Ash Wiki is maintained by a dedicated team of passionate gamers and developers who love
              Idols of Ash as much as you do. We're players first, constantly testing strategies, exploring game
            ...
            <ul>
              <li><strong>Game analysis:</strong> Deep understanding of Idols of Ash mechanics and strategies</li>
        ...
        <div className="container mx-auto max-w-4xl">
          <div className="prose prose-invert prose-slate max-w-none">
            ...
            <p className="text-yellow-400/90">
              <strong>Idols of Ash Wiki is an unofficial fan-made website.</strong> We are NOT affiliated with,
              endorsed by, or associated with the developers of Idols of Ash or any official entities.
            </p>
            <p>
            ...
            <p>
              Idols of Ash Wiki is a non-profit, community resource created by fans, for fans.
            </p>
          </div>
        </div>
      </section>
          ...
          <div className="prose prose-invert prose-slate max-w-none">
            ...
            <div className="not-prose grid md:grid-cols-2 gap-4 my-6">
              <div className="p-4 rounded-lg bg-slate-900/50 border border-slate-800">
                ...
                <a href="mailto:contact@idols-of-ash.wiki" className="text-[hsl(var(--nav-theme-light))] hover:underline">
                  contact@idols-of-ash.wiki
                </a>
              </div>
              <div className="p-4 rounded-lg bg-slate-900/50 border border-slate-800">
                <h3 className="text-lg font-semibold text-white mb-2">Bug Reports</h3>
                <a href="mailto:support@idols-of-ash.wiki" className="text-[hsl(var(--nav-theme-light))] hover:underline">
                  support@idols-of-ash.wiki
                </a>
              </div>
              <div className="p-4 rounded-lg bg-slate-900/50 border border-slate-800">
                <h3 className="text-lg font-semibold text-white mb-2">Content Submissions</h3>
                <a href="mailto:contribute@idols-of-ash.wiki" className="text-[hsl(var(--nav-theme-light))] hover:underline">
                  contribute@idols-of-ash.wiki
                </a>
              </div>
              <div className="p-4 rounded-lg bg-slate-900/50 border border-slate-800">
                <h3 className="text-lg font-semibold text-white mb-2">Partnerships</h3>
                <a href="mailto:partnerships@idols-of-ash.wiki" className="text-[hsl(var(--nav-theme-light))] hover:underline">
                  partnerships@idols-of-ash.wiki
                </a>
              </div>
            </div>
      ...
      <section className="py-12 px-4 bg-gradient-to-r from-purple-900/30 to-blue-900/30 border-y border-border">
        <div className="container mx-auto max-w-4xl text-center">
          ...
          <p className="text-slate-300 mb-6 max-w-2xl mx-auto">
            Stay updated with the latest guides, tips, and Idols of Ash news.
