...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  return {
    title: 'Privacy Policy - Idols of Ash Wiki',
    description: 'Idols of Ash Wiki Privacy Policy. Learn how we collect, use, and protect your data when you use our itch.io / Steam game resource platform. Your privacy matters to us.',
    keywords: [
      'privacy policy',
      'Idols of Ash Wiki privacy',
      'data protection',
      'user privacy',
      'GDPR compliance',
    ],
      ...
      <section className="py-12 px-4">
        <div className="container mx-auto max-w-4xl">
          <div className="prose prose-invert prose-slate max-w-none">
            ...
            <p>
              Idols of Ash Wiki ("we", "our", or "us") collects minimal information to provide and improve our services.
            ...
            <p>
              Our website may contain links to external websites, including itch.io / itch.io, and social media platforms.
            ...
            <h2>11. Disclaimer</h2>
            <p>
              Idols of Ash Wiki is an unofficial fan-made website and is not affiliated with, endorsed by, or associated
              with Leafy Games or the developers of Idols of Ash. All game content, trademarks, and assets are
            ...
            <p>
              <strong>Email:</strong> <a href="mailto:privacy@idols-of-ash.wiki" className="text-[hsl(var(--nav-theme-light))] hover:underline">privacy@idols-of-ash.wiki</a>
            </p>
            <p>
